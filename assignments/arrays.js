...
let car = inventory[32]
console.log(car.car_make, car.car_model, car.car_year)
...
// alphabetically on the website. 
// Sort all the car model names into alphabetical 
// order and log the results in the console
...
// from every car on the lot. Create a new array from 
// the dealer data containing only the car years 
...
// ==== Challenge 5 ====
// The car lot manager needs to find out how 
// many cars are older than the year 2000. 
// Using the carYears array you just created, 
// find out how many cars were made before the year 
// 2000 by populating the array oldCars and logging it's length.
...
// Once you have populated the BMWAndAudi array, 
// use JSON.stringify() to show the 
